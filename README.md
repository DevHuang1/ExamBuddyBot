...
- 📝 **Source-grounded quizzes, flashcards, and revision guides** — use `/quiz [topic]` for validated multiple-choice practice, `/flashcards [topic]` for five cited study cards that can be privately downloaded with `/flashcards export`, and `/studyguide [topic]` for an exam-ready overview, cited key points, practical tips, and a three-step study plan from uploaded PDF/PPTX sources.
